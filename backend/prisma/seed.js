...
async function main() {
    ...
    // ─── ADMIN USER ──────────────────────────────────────────────
    const adminPass = await bcryptjs_1.default.hash('Admin@1234', 12);
    ...
    for (const sub of subCategories) {
        const slug = (0, slugify_1.default)(sub.name, { lower: true, strict: true });
    ...
    for (const b of blogs) {
        const slug = (0, slugify_1.default)(b.title, { lower: true, strict: true });
